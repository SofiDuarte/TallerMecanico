...
<body>
    ...
    <section class="serv">
        ...
        <div>
            <div class="item_serv">
                <img src="servicios/5.jpg" alt="">
            </div>
            <h2>SUSPENSIÓN DELANTERA BÁSICA</h2>
            <h3>CAMBIO DE ROTULAS, BIELETA,BUJES DE PARRILLA, BUJES BARRA ESTABILIZADORA</h3>
        </div>
        
        <div>
            <div class="item_serv">
                <img src="servicios/6.jpg" alt="">
            </div>
